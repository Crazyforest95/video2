<!--热播影视-->
<div class="mod_box" id="hot_movie">			
	<h2 class="mod_tit_bg">热播影视</h2>
	<div class="mod_cont">
		<ul class="mod_list_single_pic">
			<?php
				...
				$cmedy_hot_post_query = new WP_Query($args_post);
				if($cmedy_hot_post_query->have_posts()) : while ($cmedy_hot_post_query->have_posts()) : $cmedy_hot_post_query->the_post(); 
			?>
			<li><a href="<?php the_permalink(); ?>" class="mod_single_poster">
